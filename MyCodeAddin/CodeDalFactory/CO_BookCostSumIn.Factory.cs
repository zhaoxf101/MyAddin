...
{
	public class CO_BookCostSumInFactory:Common.Business.CO_BookCostSumIn
    {
        public static Common.Business.CO_BookCostSumIn Fetch(CO_BookCostSumIn data)
        {
            Common.Business.CO_BookCostSumIn item = (Common.Business.CO_BookCostSumIn)Activator.CreateInstance(typeof(Common.Business.CO_BookCostSumIn));
            //using (ObjectFactory.BypassPropertyChecks(item))
            {
				                ...
				                item.PAROB = data.PAROB;
				                item.USPOB = data.USPOB;
				                item.IsBD = data.IsBD;
				                ...
				                item.PAF001 = data.PAF001;
				                item.PAF002 = data.PAF002;
				                item.PAF003 = data.PAF003;
				                item.PAF004 = data.PAF004;
				                item.PAF005 = data.PAF005;
				                item.PAF006 = data.PAF006;
				                item.PAF007 = data.PAF007;
				                item.PAF008 = data.PAF008;
				                item.PAF009 = data.PAF009;
				                item.PAF010 = data.PAF010;
				                item.PAF011 = data.PAF011;
				                item.PAF012 = data.PAF012;
				                item.PAF013 = data.PAF013;
				                item.PAF014 = data.PAF014;
				                item.PAF015 = data.PAF015;
				                item.PAF016 = data.PAF016;
		...
		private void DataPortal_Fetch(Common.Business.LambdaExpression lambda)
        {
            ...
            {
				var exp = lambda.Resolve<CO_BookCostSumIn>();
                var i = (from p in ctx.DataContext.CO_BookCostSumIn.Where(exp)
                ...
                if (i != null)
                {
										...
										this.PAF001 = i.PAF001;
										this.PAF002 = i.PAF002;
										this.PAF003 = i.PAF003;
										this.PAF004 = i.PAF004;
										this.PAF005 = i.PAF005;
										this.PAF006 = i.PAF006;
										this.PAF007 = i.PAF007;
										this.PAF008 = i.PAF008;
										this.PAF009 = i.PAF009;
										this.PAF010 = i.PAF010;
										this.PAF011 = i.PAF011;
										this.PAF012 = i.PAF012;
										this.PAF013 = i.PAF013;
										this.PAF014 = i.PAF014;
										this.PAF015 = i.PAF015;
										this.PAF016 = i.PAF016;
	...
	public class CO_BookCostSumInsFactory : Common.Business.CO_BookCostSumIns
    {
        private void DataPortal_Fetch()
        {
            using (var ctx = ContextManager<EFDataContext>.GetManager(Database.EFramework))
            {
                var i = from p in ctx.DataContext.CO_BookCostSumIn
                        select CO_BookCostSumInFactory.Fetch(p);
		...
		private void DataPortal_Fetch(Paging page)
        {
            ...
            {
                var i = (from p in ctx.DataContext.CO_BookCostSumIn
                        select CO_BookCostSumInFactory.Fetch(p)).Skip(page.StartIndex).Take(page.RowCount);
                this.RaiseListChangedEvents = false;
                this.IsReadOnly = false;
                this.AddRange(i);
                this.IsReadOnly = true;
        ...
        private void DataPortal_Fetch(PagigExpress page)
        {
            using (var ctx = ContextManager<EFDataContext>.GetManager(Database.EFramework))
            {
                var exp = page.Lambda.Resolve<CO_BookCostSumIn>();
                var i = (from p in ctx.DataContext.CO_BookCostSumIn.Where(exp)
                         select CO_BookCostSumInFactory.Fetch(p)).Skip(page.StartIndex).Take(page.RowCount);
                this.RaiseListChangedEvents = false;
                this.IsReadOnly = false;
