...
namespace Common.Business
{
	...
	[Serializable]
    [CMFactory(typeof(CO_BookCostSumOut))]
#if Dev
    [RunLocal]
#endif

	public class CO_BookCostSumOut:ReadOnlyBase<CO_BookCostSumOut>
    {
		...
		public static CO_BookCostSumOut Create()
        {
            return EF.DataPortal.Create<CO_BookCostSumOut>();
        }

		public static CO_BookCostSumOut Fetch(System.Linq.Expressions.Expression<Func<CO_BookCostSumOut, bool>> exp,params object[] values)
        {
			LambdaExpression lambda = LambdaExpression.Create<CO_BookCostSumOut>(exp,values);
            return EF.DataPortal.Fetch<CO_BookCostSumOut>(lambda);
        }
	...
	[Serializable]
    [CMFactory(typeof(CO_BookCostSumOuts))]
#if Dev
    [RunLocal]
#endif
	
	public class CO_BookCostSumOuts:ReadOnlyListBase<CO_BookCostSumOuts,CO_BookCostSumOut>
    {
        #region Factory Methods

        public static CO_BookCostSumOuts Fetch()
        {
            return EF.DataPortal.Fetch<CO_BookCostSumOuts>();
        }

		public static CO_BookCostSumOuts Fetch(System.Linq.Expressions.Expression<Func<CO_BookCostSumOut, bool>> exp,params object[] values)
		{
			LambdaExpression lambda = LambdaExpression.Create<CO_BookCostSumOut>(exp,values);
            return EF.DataPortal.Fetch<CO_BookCostSumOuts>(lambda);
		}

		public static CO_BookCostSumOuts Fetch(int page, int rowCount)
        {
            return EF.DataPortal.Fetch<CO_BookCostSumOuts>(new Paging { Page=page,RowCount=rowCount});
        }

        public static CO_BookCostSumOuts Fetch(int page, int rowCount, System.Linq.Expressions.Expression<Func<CO_BookCostSumOut, bool>> exp,params object[] values)
        {
            return EF.DataPortal.Fetch<CO_BookCostSumOuts>(new PagigExpress { Page=page,RowCount=rowCount,Lambda=LambdaExpression.Create<CO_BookCostSumOut>(exp,values)});
        }
